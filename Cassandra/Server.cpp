...
/*   Updated: 2023/05/25 18:22:24 by clecat           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
std::vector<int>		Server::getFdUsersDc() const{
...
/*--------------------------------------------------------*/
std::map<int, Client*>	Server::getListClient() const{
...
/*--------------------------------------------------------*/
std::vector<Channel*>	Server::getListChan() const{
