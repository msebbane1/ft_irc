...
/*   Updated: 2023/06/19 10:38:50 by student          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class Messages
{
	...
	void	RPL_ENDOFBANLIST(std::string channel, int fd); //end of ban list
	void	RPL_BANLIST(int fd, std::string channel, std::string name, int num); //show ban list
	//utils
